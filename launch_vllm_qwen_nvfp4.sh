#!/usr/bin/env bash
# =============================================================================
# launch_vllm_qwen_nvfp4.sh - Launch Qwen3.6-35B-A3B-NVFP4
# =============================================================================
# Deploys nvidia/Qwen3.6-35B-A3B-NVFP4 using generic vLLM container.
#
# Usage:
#   ./launch_vllm_qwen_nvfp4.sh [--port PORT] [--stop] [--status]
# =============================================================================
...
CONTAINER_NAME="${CONTAINER_NAME:-vllm-qwen-nvfp4-gb10}"
PORT="${PORT:-80}"
...
while [[ $# -gt 0 ]]; do
  case $1 in
    ...
    -h|--help)
      cat <<'USAGE'
Usage: ./launch_vllm_qwen_nvfp4.sh [OPTIONS]

Launch vLLM container with Qwen3.6-35B-A3B-NVFP4 on GB10.
...
# ---------------------------------------------------------------------------
echo "============================================"
echo " vLLM Container: Qwen3.6-35B-A3B-NVFP4"
echo "============================================"
echo "Model:       ${MODEL_ID}"
...
echo "Run benchmark: ./run_model_benchmark.sh --model qwen-nvfp4 --port ${HOST_PORT}"
echo "Stop server:  ./launch_vllm_qwen_nvfp4.sh --stop"
